...
export default function Hero() {
 ...
 >
 <SelectTrigger
 className="h-8 w-full border-0 bg-transparent pl-0 pr-3 !text-[16.75px] font-sans text-[#2a3a42] shadow-none ring-0 ring-offset-0 focus:ring-0 focus:ring-offset-0 lg:h-[2.645rem] lg:pl-0 lg:pr-[0.9919rem] lg:!text-[26.04px]"
