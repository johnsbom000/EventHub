  ...
  return (
    <div className="bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
        <h1 className="sm:text-5xl md:text-6xl font-bold text-center mb-12 text-foreground text-[50px]" data-testid="text-hero-title">Event vendors for any occasion</h1>
