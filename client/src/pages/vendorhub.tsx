...
export default function VendorHub() {
 ...
 const resolvedCoverImageUrl = asTrimmedString(normalizedCoverImageUrl || coverImageUrl);
  ...
  const heroContentTopSpacingClass = showHeroAvatar
    ? "vendor-hub-hero-content"
 ...
 />
              ...
              <div
                className={`${heroContentTopSpacingClass} w-full px-8 pb-2 sm:px-12 lg:px-8`}
              >
 ...
 <div>
 <h1
 className="text-[4rem] leading-tight font-semibold text-[#2a3a42] "
 ...
 <span className="text-lg text-[#2a3a42] ">
 ...
 <ListingCard
 listing={listing}
 // Match storefront card title/price sizing used on Landing.
 ...
 <span
 key={item}
 className="rounded-full border border-[rgba(74,106,125,0.25)] px-3 py-1 text-sm text-[#2a3a42] "
 >
 {item}
 </span>
 ))}
 ...
 <p className="text-[4rem] font-heading leading-none text-[#2a3a42] ">
 ...
 <span className="w-8 text-right text-[#2a3a42] ">{star}★</span>
 ...
 <span className="w-10 text-right text-[#2a3a42] ">{pct}%</span>
 </div>
 );
 })}
 </div>
