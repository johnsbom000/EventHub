          ...
          <main className="flex-1 overflow-auto p-6">
            <div className="max-w-7xl mx-auto space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">View all bookings on a calendar and filter by status.</p>
              </div>
                ...
                <CardContent className="grid gap-4 sm:grid-cols-3">
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="mt-1 text-lg font-semibold">
                      {summary.next ? summary.next.toLocaleString(undefined, { month: "short", day: "numeric", year: "numeric" }) : "No upcoming bookings"}
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <div className="mt-1 text-lg font-semibold">
                      {new Intl.NumberFormat(undefined, { style: "currency", currency: "USD" }).format((summary.upcomingRevenue || 0) / 100)}
                    </div>
                  </div>
                </CardContent>
              </Card>
