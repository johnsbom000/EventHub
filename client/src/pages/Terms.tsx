        ...
        <div className="lg:grid lg:grid-cols-[200px_1fr] lg:gap-12">
          ...
          <div className="prose prose-sm max-w-none text-foreground [&_h2]:mt-10 [&_h2]:text-xl [&_h2]:font-semibold [&_h3]:mt-6 [&_h3]:text-base [&_h3]:font-medium [&_p]:mt-3 [&_p]:leading-relaxed [&_p]:text-muted-foreground [&_ul]:mt-3 [&_ul]:space-y-1 [&_li]:text-muted-foreground">
            ...
            <section id="vendor-agreement">
              ...
              <p>
                <strong>Customer service fee.</strong> EventHub charges Customers a service fee of <strong>5%</strong> of the booked amount on every booking, on every plan and under every pricing model. It is added to the Customer's total and disclosed before checkout. Travel, delivery, and other vendor-charged fees collected through the Platform are part of the booked amount and carry the same 5% service fee.
              </p>
              <p>
                <strong>Vendor commission.</strong> EventHub charges Vendors a platform commission of <strong>8%</strong> of the booked amount on every booking, deducted from the Vendor's payout. Two exemptions apply, and only these two: (a) a Vendor on the subscription pricing model who holds an <strong>active paid EventHub Pro subscription</strong> pays a 0% commission for as long as that subscription remains active; and (b) a <strong>legacy Vendor</strong>, as defined below, pays a 0% commission permanently. Vendors on the free tier of the subscription pricing model pay the 8% commission. Vendors on the commission pricing model have no subscription and no paid tier available to them, and pay the 8% commission on all bookings. No other status, program, or promotion waives the vendor commission, and the customer service fee is never waived by a Pro subscription or by legacy status.
              </p>
              <p>
                <strong>Legacy Vendors.</strong> Vendors whose accounts were created before the vendor commission took effect were onboarded on the understanding that EventHub charged them no commission. EventHub honours that: those accounts are designated <strong>legacy</strong> and are permanently exempt from the vendor commission, at no cost and with no subscription required. This exemption is account-specific, is not transferable, and applies to the vendor commission only — <strong>the 5% customer service fee still applies to bookings made with a legacy Vendor</strong>, because that fee is charged to the Customer rather than deducted from the Vendor. EventHub reserves the right to designate individual accounts as legacy or otherwise fee-exempt, and different Vendors may therefore be charged different commission rates.
              </p>
              <p>
                Fee rates are fixed at the time each booking is created and are not changed retroactively. All applicable fees are disclosed before checkout and in the vendor dashboard. Payments are processed by our third-party payment processor (Stripe). <strong>Stripe's standard payment-processing fees are borne by the Vendor</strong> and are deducted from the Vendor's payout; they are separate from, and additional to, any EventHub commission. Payout schedules and the applicable fees are disclosed in the vendor dashboard. Payouts are processed after successful booking completion, less any applicable fees. EventHub may change its fees, fee structure, and subscription pricing at any time; any change applies only to bookings and subscription periods that begin after it takes effect, and current fees are always shown before checkout and in the vendor dashboard.
              </p>
            </section>
