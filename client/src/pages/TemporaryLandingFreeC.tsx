  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="grid lg:grid-cols-2">
        {/* LEFT — dark ink panel */}
        <div className="flex flex-col justify-center bg-[#2a3a42] px-6 py-16 lg:px-12 lg:py-28 xl:px-20">
        ...
        {/* RIGHT — bright panel with the builder mock bleeding to the edge */}
        <div className="relative overflow-hidden bg-[#f8fafb] px-6 py-16 lg:px-0 lg:py-0">
          <div className="flex h-full items-center lg:py-16">
            <div className="mx-auto w-full max-w-[460px] lg:ml-10 lg:mr-[-4rem] xl:ml-16">
              <ListingWizardDemo />
            </div>
          </div>
        </div>
