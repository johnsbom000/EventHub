  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative z-40">
        {/* Slim FREE bar */}
        <div className="bg-[#f5f0e8] text-[#4a6a7d]">
          <div className="mx-auto flex max-w-[1320px] flex-wrap items-center justify-center gap-x-3 gap-y-1 px-5 py-2 text-center lg:px-10">
            <span className="font-sans text-[0.92rem] leading-tight">
              <span className="font-semibold text-[#e07a6a]">{t(`${NS}.bar.badge`)}</span>
              <span className="mx-1.5 text-[rgba(74,106,125,0.35)]">·</span>
              <span className="text-[#4a6a7d]">{t(`${NS}.bar.text`)}</span>
            </span>
            <button
              type="button"
      ...
      {/* CENTERED HERO — single-column focus (Variation 1: Hick's Law + center-stage) */}
      <section className="bg-gradient-to-b from-[#f5f0e8] to-white">
        <div className="mx-auto max-w-[840px] px-5 py-20 text-center lg:py-28">
          <Eyebrow>{t(`${NS}.hero.eyebrow`)}</Eyebrow>
          <h1 className="mx-auto max-w-[17ch] font-heading text-[clamp(2.8rem,6vw,4.7rem)] font-light leading-[1.03] text-[#2a3a42]">
            <Trans
              i18nKey={`${NS}.hero.title`}
              components={{ accent: <em className="italic text-[#e07a6a]" /> }}
            />
          </h1>
          <p className="mx-auto mt-6 max-w-[46ch] font-sans text-[1.2rem] leading-[1.6] text-[#4a6a7d]">
            {t(`${NS}.hero.subtitle`)}
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <PrimaryButton onClick={() => handleSignupCta("hero_primary")} className="!px-8 !py-4 !text-[1.1rem]">{t(`${NS}.hero.ctaPrimary`)}</PrimaryButton>
            <button
              type="button"
              onClick={openLogin}
              className="rounded-[12px] px-6 py-4 font-sans text-[1.1rem] font-semibold text-[#4a6a7d] transition-colors hover:text-[#2a3a42]"
            >
              {t(`${NS}.hero.logIn`)}
            </button>
          </div>
          <p className="mt-5 font-sans text-[0.95rem] text-[#9aacb4]">{t(`${NS}.hero.trustLine`)}</p>
          <div className="mx-auto mt-14 w-full max-w-[560px]">
            <ListingWizardDemo />
          </div>
        </div>
      </section>
      ...
      {/* CLOSING — light centered band (matches the airy centered hero) */}
      <section className="border-t border-[rgba(74,106,125,0.08)] bg-[#f5f0e8]">
        <div className="mx-auto max-w-[720px] px-5 py-20 text-center lg:px-10 lg:py-24">
          ...
          <p className="mt-6 font-sans text-[0.9rem] text-[#9aacb4]">
