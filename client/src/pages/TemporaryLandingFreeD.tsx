...
import { Header, Closing, Footer, Eyebrow, PrimaryButton } from "@/pages/landing/primitives";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-b from-[#f5f0e8] to-white">
        <div className="mx-auto max-w-[820px] px-5 py-20 text-center lg:py-28">
          <Eyebrow>{t(`${NS}.hero.eyebrow`)}</Eyebrow>
          <h1 className="mx-auto mt-4 max-w-[16ch] font-heading text-[clamp(2.9rem,6.4vw,4.9rem)] font-light leading-[1.02] text-[#2a3a42]">
